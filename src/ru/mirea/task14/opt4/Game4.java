...
public class Game4 {
    ...
    public static void main(String[] args) {
        System.out.println(new ru.mirea.task14.opt1.Game("13579", "24680").play());
        System.out.println(new ru.mirea.task14.opt1.Game("12345", "67890").play());
        System.out.println(new ru.mirea.task14.opt1.Game("13029", "42685").play());
    }
}
